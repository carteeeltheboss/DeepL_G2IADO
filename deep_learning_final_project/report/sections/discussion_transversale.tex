...
\begin{itemize}
    \item Sur les données tabulaires (30 variables, Breast Cancer), le MLP
          atteint un F1 $> 0{,}94$ car les variables sont déjà des descripteurs
          informatifs.
    \item Sur les images ($28 \times 28$, Fashion-MNIST), le CNN dépasse le
          MLP d'environ 3\,\% d'accuracy car il exploite la localité
          spatiale.
    \item Sur les séquences textuelles, les architectures récurrentes
