...
\input{sections/partie1_mlp}
\input{sections/partie2_cnn}
\input{sections/partie3_sequences}
\input{sections/discussion_transversale}
\input{sections/limites}
